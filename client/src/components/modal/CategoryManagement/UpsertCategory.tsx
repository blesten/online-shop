...
const UpsertCategory: React.FC<IProps> = ({ openUpsertCategoryModal, setOpenUpsertCategoryModal, upsertCategoryModalRef, selectedCategory, setSelectedCategory }) => {
  ...
  return (
    <div className={`${openUpsertCategoryModal ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} fixed top-0 left-0 bottom-0 right-0 bg-[rgba(0,0,0,.6)] flex items-center justify-center z-20 transition-opacity`}>
