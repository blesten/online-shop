...
const UpsertProductDiscount: React.FC<IProps> = ({ openUpsertProductDiscountModal, setOpenUpsertProductDiscountModal, upsertProductDiscountModalRef, setActiveDiscount, selectedProductDiscount, setSelectedProductDiscount }) => {
  ...
  return (
    <div className={`${openUpsertProductDiscountModal ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} fixed top-0 left-0 bottom-0 right-0 bg-[rgba(0,0,0,.6)] flex z-20 items-center justify-center transition-opacity`}>
