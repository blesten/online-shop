          ...
          <div className='mb-10'>
            ...
            <div onClick={handleClickAvatar} className='w-fit mb-10 m-auto'>
              <div className='bg-gray-100 border border-gray-300 w-28 h-28 relative rounded-full cursor-pointer group shadow-lg'>
                {
                  tempAvatar.length > 0
                  ? <img src={URL.createObjectURL(tempAvatar[0])} alt='User Avatar' className='w-full h-full rounded-full object-cover border border-gray-200' />
                  : (
                    <>
                      {
                        customerInformation.avatar
                        ? <img src={customerInformation.avatar} alt='User Avatar' className='w-full h-full rounded-full object-cover' />
                        : (
